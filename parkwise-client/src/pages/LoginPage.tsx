...
import { LogIn, Mail, Lock, ArrowRight, AlertCircle, Chrome, Github, Globe, Car, ShieldCheck } from 'lucide-react';
import { AppUser, loginUser, saveSession } from '../lib/api';
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="font-bold text-gray-600 group-hover:text-orange-600">Sign in with Microsoft</span>
            </button>
          </div>
